...
#+LASTMOD: 2022-08-31T22:10:12+0800
#+TAGS[]: tips
...
目前使用的配置可参考：[[/elisp/project-config.el][project-config.el]]，对于 27 版本的用户，可以在[[https://elpa.gnu.org/packages/project.html][这里]]下载最新的版本。这次去掉的其他华而不实的包主要还有：
- evil-numbers
